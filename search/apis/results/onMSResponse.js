...
module.exports = function(message, jwt, forward, sendBack) {
    console.log("search RESULTS message in: " + JSON.stringify(message, null, 2));
    //Is there 'owt to forward?
    ...
    var batchRequest = messageMap.request.getRequestMessage(message);
    //Forward request...
    console.log("search RESULTS message out to Batch: " + JSON.stringify(batchRequest,null,2));
    forward(batchRequest,jwt,function(responseObj) {
