...
//which in turns forward to results 
...
module.exports = function(message, jwt, forward, sendBack) {
        ...
        message.req.body.service = "REPO";
        message.req.body.operation = "SEARCH"
        message.req.body.serviceMode = "pipeline"
        message.req.body.pipeline = ["tests"],
        message.req.body.registry = registry[message.req.body.data.query.resourceType];
    
        var repoSearchQueryRequest = {
            path:"/services/v1/repo/search",
            method:"POST",
            body:message.req.body
        }

        console.log("repo SEARCH message out: " + JSON.stringify(repoSearchQueryRequest,null,2));
        forward(repoSearchQueryRequest,jwt,function(responseObj) {
