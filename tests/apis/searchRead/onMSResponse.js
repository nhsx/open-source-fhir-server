...
module.exports = function(message, jwt, forward, sendBack) {
    ...
    console.log("search READ message in: " + JSON.stringify(message,null,2));
    ...
    var path = "/services/v1/search/" + message.searchSetId + "/paginate/" + page + "/" + pageSize;
    ...
    console.log("search READ message out: " + JSON.stringify(searchResults,null,2));
    forward(searchResults,jwt,function(responseObj) {
