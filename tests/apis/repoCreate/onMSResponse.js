...
module.exports = function(message, jwt, forward, sendBack) {
    ...
    var createLocalRepoResourceRequest = {
        path:"/services/v1/repo/create",
        method:"POST",
        body:message.req.body
    }
    console.log("repo CREATE message out: " + JSON.stringify(createLocalRepoResourceRequest,null,2));
    forward(createLocalRepoResourceRequest,jwt,function(responseObj) {
