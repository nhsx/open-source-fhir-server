...
module.exports = function(message, jwt, forward, sendBack) {
    console.log("repo Batch READ");
    console.log("repo Batch READ message in: " + JSON.stringify(message,null,2));

    message.req.body.service = "REPO";
    message.req.body.operation = "BATCH-READ"
    message.req.body.serviceMode = "standalone"
    message.req.body.pipeline = ["tests"]

    var createBatchReadRequest = {
        path:"/services/v1/repo/batch",
        method:"POST",
        body:message.req.body
    }
    console.log("repo Batch READ message out: " + JSON.stringify(createBatchReadRequest,null,2));
    forward(createBatchReadRequest,jwt,function(responseObj) {
