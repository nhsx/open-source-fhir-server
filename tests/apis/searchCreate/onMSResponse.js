...
module.exports = function(message, jwt, forward, sendBack) {
    ...
    console.log("search CREATE message in: " + JSON.stringify(message,null,2));
    ...
    var path = "/services/v1/search";

    var saveSearchResults = {
        path: path,
        method:"POST",
        body:message.req.body
    }
    console.log("search CREATE message out: " + JSON.stringify(saveSearchResults,null,2));
    forward(saveSearchResults,jwt,function(responseObj) {
