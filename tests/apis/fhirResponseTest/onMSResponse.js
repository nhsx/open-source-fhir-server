...
module.exports = function(message, jwt, forward, sendBack) {
    console.log("fhir-response CREATE");
    console.log("fhir-response CREATE message in: " + JSON.stringify(message,null,2));

    message.req.body.service = "FHIR-RESPONSE";
    message.req.body.operation = "CREATE"
    message.req.body.serviceMode = "standalone"
    message.req.body.pipeline = [
        "tests"
    ]

    var createFhirResponseRequest = {
        path:"/services/v1/responder/create",
        method:"POST",
        body:message.req.body
    }
    console.log("fhir-response CREATE message out: " + JSON.stringify(createFhirResponseRequest,null,2));
    forward(createFhirResponseRequest,jwt,function(responseObj) {
