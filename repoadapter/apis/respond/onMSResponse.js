...
module.exports = function(message, jwt, forward, sendBack) {
    console.log('REPO ADAPTER service RESPOND message in: ' + JSON.stringify(message,null,2));
    ...
    //Create the fhirResponder request...
    var responderRequest = messageMap.request.getRequestMessage(message);
    //Forward...
    console.log("REPO ADAPTER service RESPOND message out: " + JSON.stringify(responderRequest,null,2));
    forward(responderRequest, jwt, function(responseObj) {
